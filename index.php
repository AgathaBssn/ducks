...
<head>
    ...
    <title>Hide and Ducks</title>
    <style>
        <?php foreach ($places as $place): ?>
        .place-color-<?= htmlspecialchars(strtolower($place['label'])) ?> {
            background-color: <?= htmlspecialchars($place['color']) ?>;
        }
        <?php endforeach; ?>
    </style>
</head>
...
<div class="grid">
    <?php foreach ($ducks as $duck): ?>
        <div class="duck place-color-<?= htmlspecialchars(strtolower($duck['place'])) ?> <?= $duck['etat'] === 'trouvé' ? 'found' : '' ?>">
            ...
            <strong><?= htmlspecialchars($duck['name']) ?></strong><br />
            <div class="tooltip-zone">
                ...
                <div class="tooltip-content">
                    ...
                    <form method="post" action="change_place.php">
                        ...
                        <label for="etat">Trouvé</label><br />
...
<aside id="sidebar" class="sidebar">
    ...
    <ul>
        <?php foreach ($places as $place): ?>
            <li>
                <span class="legend-color" style="background-color: <?= htmlspecialchars($place['color']) ?>"></span>
